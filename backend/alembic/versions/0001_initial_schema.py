...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('binary_alert_decision', sa.Boolean(), nullable=False, server_default=sa.false()),
    ...
    op.create_table(
        ...
        sa.Column('is_hysteresis_dampened', sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column('model_version', sa.String(length=50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column('any_decision_flipped', sa.Boolean(), nullable=False, server_default=sa.false()),
        ...
        sa.Column('include_shap', sa.Boolean(), nullable=False, server_default=sa.true()),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    )
